...
const Account = () => {
  ...
  const { username, userId, setEmail, setBirthdate, categories, setCategories } = useUser();
        ...
        <Box overflowX="auto" width="100%" display="grid" gridTemplateColumns="min-content auto min-content" gap={4}>
          ...
          >
            ...
            <Text fontSize={{ base: '17px', lg: '20px' }} color="white" mb={2}>
              {useBreakpointValue({ base: getTruncatedUsername(username || 'vladasologybova@gmail.com'), lg: username || 'vladasologybova@gmail.com' })}
            </Text>
            <Button
              bg="#A3B3F2"
              color="white"
